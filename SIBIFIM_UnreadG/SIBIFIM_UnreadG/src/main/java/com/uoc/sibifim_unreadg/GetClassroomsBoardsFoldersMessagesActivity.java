package com.uoc.sibifim_unreadg;
...
public class GetClassroomsBoardsFoldersMessagesActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            /* UOCAPICALL /api/v1/subjects/{domain_id}/boards/{board_id}/folders/{id}/messages/unread GET*/
            String ml;
            HttpClient httpClient = new DefaultHttpClient();
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/boards/"+param[2]+"/folders/"+param[3]+"/messages/unread?access_token="+param[0]+"&start=" + "0" + "&end=" + "1000");
            ...
            //OR return MessageList.getUnreadfromSubjectBoardFolderWS(param[0], param[1], param[2], param[3], "0", "1000"); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

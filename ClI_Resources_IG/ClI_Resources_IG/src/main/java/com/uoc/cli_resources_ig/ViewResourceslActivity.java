package com.uoc.cli_resources_ig;
...
/*STARTUOCAPIEXAMPLE*/
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Resource> {
        ...
        protected Resource doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+ param[1] + "/resources/" + param[2]+"?access_token="+param[0]);
            httpGet.setHeader("content-type", "application/json");
            try {
                HttpResponse resp = httpClient.execute(httpGet);
                r = EntityUtils.toString(resp.getEntity());
            } catch (Exception ex) {
                Log.e("REST", "GET Error!", ex);
                return null;
            }
            return new Gson().fromJson(r,Resource.class);
            //OR return Resource.getResourcefromClassRoomWS(param[0], param[1], param[2]); if you are using our library
        }
    }
/*ENDUOCAPIEXAMPLE*/

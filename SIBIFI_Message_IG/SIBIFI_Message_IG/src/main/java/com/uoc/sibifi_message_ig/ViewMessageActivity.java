...
public class ViewMessageActivity extends Activity{
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Message> {
        ...
        protected Message doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/boards/"+param[2]+"/folders/"+param[3]+"/messages/"+param[4]+"?access_token="+param[0]);
            ...
            //OR return Message.getMessagefromSubjectBoardFolderWS(param[0], param[1], param[2], param[3], param[4]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

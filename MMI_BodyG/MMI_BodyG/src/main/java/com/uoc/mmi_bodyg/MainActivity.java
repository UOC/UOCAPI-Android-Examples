...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.mmi_bodyg.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.mmi_bodyg.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.mmi_bodyg.R.menu.activity_main, menu);
        return true;
    }

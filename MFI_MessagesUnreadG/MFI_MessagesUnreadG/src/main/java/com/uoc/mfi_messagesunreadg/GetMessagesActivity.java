package com.uoc.mfi_messagesunreadg;
...
public class GetMessagesActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/"+param[1]+"/messages/unread?access_token="+param[0]+"&start=" + "0" + "&end=" + "1000");
            ...
            //OR return MessageList.getUnreadfromMailFolderWS(param[0], param[1], "0", "1000"); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

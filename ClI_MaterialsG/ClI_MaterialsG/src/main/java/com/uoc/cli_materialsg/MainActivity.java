...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.cli_materialsg.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.cli_materialsg.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.cli_materialsg.R.menu.activity_main, menu);
        return true;
    }

...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.mailfolders_ig.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.mailfolders_ig.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.mailfolders_ig.R.menu.activity_main, menu);
        return true;
    }

package com.uoc.clibim_unreadg;
...
public class GetClassroomsBoardsMessagesActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/" + param[1] + "/boards/" + param[2] + "/messages/unread?access_token="+param[0]+"&start=" + "0" + "&end=" + "1000");
            ...
            //OR return MessageList.getUnreadfromClassRoomBoardWS(param[0], param[1], param[2], "0", "1000"); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

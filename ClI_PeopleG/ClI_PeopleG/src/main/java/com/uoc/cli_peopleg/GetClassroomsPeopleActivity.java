...
public class GetClassroomsPeopleActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, UserList> {
        ...
        protected UserList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+ param[1] + "/people"+"?access_token="+param[0]);
            ...
            //OR return UserList.getUserListfromClassroomWS(param[0], param[1]); IF YOU USE OUR LIBRARY
        }
    }
/*ENDUOCAPIEXAMPLE*/

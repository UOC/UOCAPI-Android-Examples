...
public class FolderList {
	...
	public static FolderList getMailFolderListWS(String token) {
		String fl = RESTMethod.Get(
	...
	public static FolderList getFolderListfromSubjectBoardWS(String token, String subject_id, String board_id) {
		String fl = RESTMethod.Get(

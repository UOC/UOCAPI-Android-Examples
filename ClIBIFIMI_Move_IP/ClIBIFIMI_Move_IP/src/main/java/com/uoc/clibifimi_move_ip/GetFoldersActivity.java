...
public class GetFoldersActivity extends Activity {
    ...
    private class MoveToFolderTask extends AsyncTask<String, Void, Folder> {
        ...
        protected Folder doInBackground(String... token) {
            /* UOCAPICALL /api/v1/classrooms/{domain_id}/boards/{board_id}/folders/{source_id}/messages/{id}/move/{destination_id} POST*/
            String faux;
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+Cid+"/boards/"+Bid+"/folders/"+OFid+"/messages/"+Mid+"/move/"+f.getId() +"?access_token="+ Utils.getToken());
            ...
            //OR return Folder.postMoveMessageinClassRoomBoarFoldertoFolderWS(token[0], Cid, Bid, OFid, Mid, f.getId()); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
}
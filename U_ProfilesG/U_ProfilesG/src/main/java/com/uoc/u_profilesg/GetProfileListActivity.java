...
public class GetProfileListActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, ProfileList> {
        ...
        protected ProfileList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/user/profiles"+"?access_token="+param[0]);
            ...
            return new Gson().fromJson(pl, ProfileList.class);
            //OR return ProfileList.getOwnProfileListWS(param[0]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

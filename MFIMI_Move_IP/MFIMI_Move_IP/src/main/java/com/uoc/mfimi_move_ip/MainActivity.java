...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.mfimi_move_ip.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.mfimi_move_ip.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.mfimi_move_ip.R.menu.activity_main, menu);
        return true;
    }

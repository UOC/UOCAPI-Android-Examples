package com.uoc.clibi_messagep;
...
public class ViewMessageActivity extends Activity{
    ...
    private class NewMessageTask extends AsyncTask<String, Void, Message> {
        ...
        protected Message doInBackground(String... token) {
            ...
            HttpPost httpPost = new HttpPost("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/" + Cid + "/boards/" + Bid + "/messages" +"?access_token="+ Utils.getToken());
            ...
            //OR return Message.postMessageinClassRoomBoardWS(token[0], Cid, Bid, m); if you use our library
        }
    }

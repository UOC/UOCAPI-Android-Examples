package com.uoc.cli_peopleteachersg;
...
public class GetClassroomsPeopleActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, UserList> {
        ...
        protected UserList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+ param[1] + "/people/teachers"+"?access_token="+param[0]);
            ...
            //OR return UserList.getTeachersfromClassRoomWS(param[0], param[1]); if you use our library
        }
    }
/*ENDUOCAPIEXAMPLE*/
    @Override

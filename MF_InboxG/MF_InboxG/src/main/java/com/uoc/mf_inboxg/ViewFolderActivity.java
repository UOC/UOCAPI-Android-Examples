...
public class ViewFolderActivity extends Activity{
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Folder> {
        ...
        protected Folder doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/inbox"+"?access_token="+param[0]);
            ...
            // OR return Folder.getInboxMailFolderWS(param[0]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

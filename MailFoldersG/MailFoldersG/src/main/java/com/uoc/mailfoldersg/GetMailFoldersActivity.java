...
public class GetMailFoldersActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, FolderList> {
        ...
        protected FolderList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/folders"+"?access_token="+param[0]);
            ...
            //OR return FolderList.getMailFolderListWS(param[0]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

...
public class GetClassroomsBoardsActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, BoardList> {
        ...
        protected BoardList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+ param[1] + "/boards"+"?access_token="+param[0]);
            ...
            //OR return BoardList.getBoardListfromClassRoomWS(param[0], param[1]); IF YOU USE OUR LIBRARY
        }
    }
/*ENDUOCAPIEXAMPLE*/

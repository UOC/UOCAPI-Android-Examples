...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.mfi_messagesg.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.mfi_messagesg.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.mfi_messagesg.R.menu.activity_main, menu);
        return true;
    }

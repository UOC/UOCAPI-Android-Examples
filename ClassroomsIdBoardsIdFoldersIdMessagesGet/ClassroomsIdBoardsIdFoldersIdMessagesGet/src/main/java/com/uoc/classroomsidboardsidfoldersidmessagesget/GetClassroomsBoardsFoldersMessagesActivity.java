package com.uoc.classroomsidboardsidfoldersidmessagesget;
...
/*STARTUOCAPIEXAMPLE*/
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/" + param[1] + "/boards/" + param[2] + "/folders/" + param[3] + "/messages?access_token="+param[0]+"&start=" + "0" + "&end=" + "1000");
            ...
            //OR return MessageList.getMessagesfromClassRoomBoardFolderWS(param[0], param[1], param[2], param[3], "0", "1000"); IF YOU USE OUR LIBRARY
        }
    }
/*ENDUOCAPIEXAMPLE*/

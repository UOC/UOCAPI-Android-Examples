package com.uoc.sibi_messagesp;
...
public class ViewMessageActivity extends Activity{
    ...
    private class NewMessageTask extends AsyncTask<String, Void, Message> {
        ...
        protected Message doInBackground(String... token) {
            ...
            HttpPost httpPost = new HttpPost("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/" + Cid + "/boards/" + Bid + "/messages" +"?access_token="+ Utils.getToken());
            try {
            ...
            //OR return Message.postMessageinSubjectBoardWS(Utils.getToken(), Cid, Bid, m); if you use our library
        }
    }

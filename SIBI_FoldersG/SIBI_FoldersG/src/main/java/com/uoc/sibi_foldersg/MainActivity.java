...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.sibi_foldersg.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.sibi_foldersg.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.sibi_foldersg.R.menu.activity_main, menu);
        return true;
    }

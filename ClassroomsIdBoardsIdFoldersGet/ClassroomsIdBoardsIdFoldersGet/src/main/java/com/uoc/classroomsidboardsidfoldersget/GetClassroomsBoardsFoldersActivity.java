...
/*STARTUOCAPIEXAMPLE*/
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, FolderList> {
        ...
        protected FolderList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms/"+ param[1] + "/boards/" + param[2] + "/folders"+"?access_token="+param[0]);
            ...
            //OR return FolderList.getFolderListfromClassRoomBoardWS(param[0], param[1], param[2]); IF YOU USE OUR LIBRARY
        }
    }
/*ENDUOCAPIEXAMPLE*/

...
public class ViewBoardActivity extends Activity{
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Board> {
        ...
        protected Board doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/boards/"+param[2]+"?access_token="+param[0]);
            ...
            //OR return Board.getBoardfromSubjectWS(param[0],param[1], param[2]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

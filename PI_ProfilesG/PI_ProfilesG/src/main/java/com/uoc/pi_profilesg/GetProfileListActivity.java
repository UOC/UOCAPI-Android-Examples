...
public class GetProfileListActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PID = myIntent.getStringExtra("PID");
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, ProfileList> {
        ...
        protected ProfileList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/people/"+param[1]+"/profiles"+"?access_token="+param[0]);
            ...
            return new Gson().fromJson(evl, ProfileList.class);
            //OR return ProfileList.getPersonProfileWS(param[0],param[1]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

...
public class GetClassroomsBoardsFoldersMessagesActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                                    int pos, long id) {
                m = listF.get(pos);
                Intent newintent = new Intent (getApplicationContext(), ViewBodyActivity.class);
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            return MessageList.getMessagesfromSubjectBoardFolderWS(param[0], param[1], param[2], param[3], "0", "1000");
        }
    }

 ...
 */
public class GetClassroomsBoardsMessagesActivity extends Activity{
    /*STARTUOCAPIEXAMPLE*/
    Message m;
    String Cid;
    String Bid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                GetClassroomsBoardsMessagesActivity.this.startActivity(newintent);
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, MessageList> {
        ...
        protected MessageList doInBackground(String... param) {
            /* UOCAPICALL /api/v1/subjects/{domain_id}/boards/{id}/messages/unread GET*/
            String ml;
            HttpClient httpClient = new DefaultHttpClient();
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/boards/"+param[2]+"/messages/unread?access_token="+param[0]+"&start=" + "0" + "&end=" + "1000");
            ...
            //OR return MessageList.getUnreadfromSubjectBoardWS(param[0], param[1], param[2], "0", "1000"); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

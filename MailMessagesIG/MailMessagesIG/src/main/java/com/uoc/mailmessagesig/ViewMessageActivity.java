...
public class ViewMessageActivity extends Activity{
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Message> {
        ...
        protected Message doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/messages/"+param[1]+"?access_token="+param[0]);
            ...
            //OR return Message.getMessagefromMailWS(param[0], param[1]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

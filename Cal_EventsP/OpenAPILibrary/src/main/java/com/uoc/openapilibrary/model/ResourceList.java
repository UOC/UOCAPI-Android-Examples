...
public class ResourceList {
	...
	public static ResourceList getResourceListfromClassroomWS(String token, String id) {
	...
	public static ResourceList getResoucesListfromSubjectWS(String token, String subject_id) {
		String rl = RESTMethod

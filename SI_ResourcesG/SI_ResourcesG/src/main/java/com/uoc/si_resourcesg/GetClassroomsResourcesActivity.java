...
public class GetClassroomsResourcesActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, ResourceList> {
        ...
        protected ResourceList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/resources"+"?access_token="+param[0]);
            ...
            //OR return ResourceList.getResoucesListfromSubjectWS(param[0], param[1]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

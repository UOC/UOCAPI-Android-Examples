...
public class Event {
	...
	public static Event JSONtoEvent(String event) {
		Gson gs = new Gson();
	...
	public static Event getEventWS(String token, String id) {
	...
	public static Event postEventWS(String token, Event newEvent) {
		return JSONtoEvent(RESTMethod

...
public class GetClassroomsPeopleActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, UserList> {
        ...
        protected UserList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/user/tutors"+"?access_token="+param[0]);
            ...
            //OR return UserList.getUserTutorsListWS(param[0]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

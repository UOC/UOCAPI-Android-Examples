...
public class GetClassroomsActivity extends Activity {
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, ClassroomList> {
        ...
        protected ClassroomList doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/classrooms"+"?access_token="+param[0]);
            ...
            //OR return ClassroomList.getClassroomListWS(param[0]); IF YOU USE OUR LIBRARY
        }
    }
/*ENDUOCAPIEXAMPLE*/

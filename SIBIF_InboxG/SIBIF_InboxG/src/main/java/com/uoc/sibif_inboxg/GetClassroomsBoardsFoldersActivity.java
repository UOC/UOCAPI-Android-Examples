...
public class GetClassroomsBoardsFoldersActivity extends Activity{
    ...
    private class LoadClassroomTask extends AsyncTask<String, Void, Folder> {
        ...
        protected Folder doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/boards/"+param[2]+"/folders/inbox"+"?access_token="+param[0]);
            ...
            //OR return Folder.getInboxFolderfromSubjectBoardWS(param[0], param[1], param[2]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

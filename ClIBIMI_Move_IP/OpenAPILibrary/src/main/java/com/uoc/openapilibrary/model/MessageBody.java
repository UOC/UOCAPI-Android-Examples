...
public class MessageBody {
	...
	public static MessageBody getMessageBodyfromClassRoomBoardFolderMessageWS(String token, String domain_id, String board_id,String folder_id, String message_id) {
	...
	public static MessageBody getMessageBodyfromMailWS(String token, String message_id) {
		String m = RESTMethod.Get(
	...
	public static MessageBody getMessageBodyfromSubjectBoardFolderMessageWS(String token, String subject_id, String board_id, String folder_id,String message_id) {
		String m = RESTMethod.Get(

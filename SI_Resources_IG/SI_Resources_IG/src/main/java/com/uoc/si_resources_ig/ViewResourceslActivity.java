...
public class ViewResourceslActivity extends Activity{
    ...
    private class LoadEventTask extends AsyncTask<String, Void, Resource> {
        ...
        protected Resource doInBackground(String... param) {
            ...
            HttpGet httpGet = new HttpGet("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/subjects/"+param[1]+"/resources/"+param[2]+"?access_token="+param[0]);
            ...
            //OR return Resource.getResourcefromSubjectWS(param[0], param[1], param[2]); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
    @Override

...
public class MainActivity extends LoginActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uoc.si_resources_ig.R.layout.activity_main);
        Login = (Button) findViewById(com.uoc.si_resources_ig.R.id.btnLogin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.uoc.si_resources_ig.R.menu.activity_main, menu);
        return true;
    }

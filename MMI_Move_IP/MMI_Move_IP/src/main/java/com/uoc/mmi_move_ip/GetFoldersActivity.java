...
public class GetFoldersActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = myIntent.getParcelableExtra("Message");
    ...
    private class MoveToFolderTask extends AsyncTask<String, Void, Folder> {
        ...
        protected Folder doInBackground(String... token) {
            /* UOCAPICALL /api/v1/mail/messages/{id}/move/{folder_id} POST*/
            String faux;
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("http://oslo.uoc.es:8080/webapps/uocapi/api/v1/mail/messages/"+m.getId()+"/move/"+f.getId() +"?access_token="+ Utils.getToken());
            ...
            //OR return Folder.postMoveMessagetoFolderWS(token[0], m.getId(), f.getId()); if you use our library
        }
    }
    /*ENDUOCAPIEXAMPLE*/
}
